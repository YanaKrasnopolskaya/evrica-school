  ...
  <footer class="footer">
    <div class="footer__about">
      <div class="footer__logo">
        <picture>
          <source
            srcset="/images/desktop/dt-footer-logo.webp"
            type="image/webp"
            media="(min-width: 768px)"
          />
          <img
            src="/images/mobile/mb-footer-logo.png"
            alt="Логотив Эврика"
            width="290"
            height="144"
          />
      ...
      <div class="socials">
        ...
        <span class="socials__disclaimer"
          >*Instagram&nbsp;&mdash; продукт компании Meta Platforms Inc., деятельность которой
          запрещена на&nbsp;территории&nbsp;РФ</span
        >
      </div>
    </div>
    <div class="footer__info-wrapper">
      <div class="info">
        ...
        >
        <NuxtLink class="info__link" to="/information"
  ...
  &:hover {
    ...
    .developer__btn {
      ...
      background: radial-gradient(
        64.96% 259.75% at 50% 50%,
        #03a5c9 0%,
        #005d83 67.44%,
        #002c3e 100%
      );
      box-shadow:
        0 0 12px 0 rgba(255, 255, 255, 1) inset,
